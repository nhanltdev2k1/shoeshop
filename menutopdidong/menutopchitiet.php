        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="trang-chu" class="logo">
                    <img src="hinhmenu/logo/logo_hype.png" alt="Hype Store Logo">
                </a>
            </div>
            <div class="header-right">
                <div class="header-icon header-search header-search-popup header-search-category d-none d-sm-block">
                    ...
                    <form action="#" method="get">
                        <div class="header-search-wrapper">
                            <input type="search" class="form-control" name="q" id="q" placeholder="Tôi đang tìm kiếm..." required="">
                            <button class="btn icon-search-3" type="submit"></button>
                        </div>
                    </form>
                </div>
                <a href="#" class="header-icon header-icon-user" title="Đăng nhập"><i class="icon-user-2"></i></a>
                <a href="#" class="header-icon" title="Danh sách yêu thích"><i class="icon-wishlist-2"></i></a>
                <div class="dropdown cart-dropdown">
                    ...
                    <div class="dropdown-menu mobile-cart">
                        <a href="#" title="Đóng (Esc)" class="btn-close">×</a>
                        <div class="dropdownmenu-wrapper custom-scrollbar">
                            <div class="dropdown-cart-header">Giỏ hàng</div>
                            <div class="dropdown-cart-action">
                                <a href="#" class="btn btn-gray btn-block view-cart">Xem Giỏ Hàng</a>
                                <a href="lien-he" class="btn btn-dark btn-block text-white">Thanh Toán</a>
                            </div>
                        </div>
                    </div>
                </div>
