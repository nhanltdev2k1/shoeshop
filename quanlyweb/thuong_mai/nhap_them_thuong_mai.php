  ...
  <table width="780" height="297" border="1" style="border-collapse:collapse">
	...
	if($today2=='Sun')
		...
		$thu='Chủ Nhật';*/
          ...
          upload($noidung, $tentaptin, $tieude,   $mota, $trangchu, $noidung_en, $tieude_en, $mota_en);
        }



        function upload($noidung, $tentaptin, $tieude,   $mota, $trangchu, $noidung_en, $tieude_en, $mota_en)

        {
          ...
          $truyvan = "INSERT INTO thuong_mai (hinhanh,noidung,mota,tieude,trangchu,noidung_en,tieude_en,mota_en) VALUES ('" . $tentaptin . "','" . $noidung . "','" . $mota . "','" . $tieude . "', '" . $trangchu . "', '" . $noidung_en . "', '" . $tieude_en . "','" . $mota_en . "')";
