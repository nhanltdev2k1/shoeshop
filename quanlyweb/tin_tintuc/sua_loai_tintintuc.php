...
function upload($thuocloai,$thuocloai_en, $id)
 {
   ...
   $truyvan = "update  loai_tin_tintuc set `thuocloai` = '$thuocloai' , `thuocloai_en` = '$thuocloai_en' where id='$id'";
...
?></td>
  ...
  <tr>
   ...
   include('db.php');
   $id=$_REQUEST["id"];
   $result=mysql_query("SELECT * FROM loai_tin_tintuc where id like '$id' ");
