                    ...
                    <table width='780' border='1' bordercolor='black' style='border-collapse:collapse'>
                        ...
                        <tr>
                            ...
                            <td>
                                <div align="left">
                                    <label>
                                        <input name="tieude_en" type="text" id="masp2" value="<?php echo "$tieude_en"; ?>" size="50" maxlength="150" />
                                    </label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div align="left">
                                    <label
                                        <label>
                                        <input name="mota" type="text" id="mota" value="<?php echo "$mota"; ?>" size="50" maxlength="150" />
                                    </label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div align="left"><strong>Mô tả tiếng Anh</strong></div>
                            </td>
                            <td>
                                <div align="left">
                                    <label>
                                        <input name="mota_en" type="text" id="mota_en" value="<?php echo "$mota_en"; ?>" size="50" maxlength="150" />
                                    </label>
                                </div>
                            </td>
                        </tr>
