  ...
  <table width="780" height="297" border="1" style="border-collapse:collapse">
	...
	if($today2=='Sun')
...

        {
          ...
          $truyvan = "INSERT INTO gioi_thieu (hinhanh,noidung,mota,tieude,trangchu,noidung_en,tieude_en,mota_en) VALUES ('".$tentaptin."','".$noidung."','".$mota."','".$tieude."', '".$trangchu."', '".$noidung_en."', '".$tieude_en."','".$mota_en."')";
