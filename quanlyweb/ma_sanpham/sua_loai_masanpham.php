    ...
    <tr>
      <td height="58" valign="top">
        ...
        if (isset($_POST['luu'])) {
          ...
          upload($thuocloai, $thuocloai_en, $tentaptin, $tenlogo, $noidung, $noidung_en, $id, $url);
        }

        function upload($thuocloai, $thuocloai_en, $tentaptin, $tenlogo, $noidung, $noidung_en, $id, $url)
        {
          include('db.php');
          //$ketnoi_maychu = ketnoi_MC();
          ///chon_CSDL($ketnoi_maychu);
          $truyvan = "update  loai_ma_sanpham set `thuocloai` = '$thuocloai' , `thuocloai_en` = '$thuocloai_en' , `hinhanh` = '$tentaptin' , `logo` = '$tenlogo', `noidung` = '$noidung' , `name_url` = '$url' , `noidung_en` = '$noidung_en' where id='$id'";
          echo $truyvan;
