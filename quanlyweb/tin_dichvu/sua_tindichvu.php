    ...
    <tr>
      <td height="112" valign="top">
        ...
        if (isset($_POST['luu'])) {
          ...
          upload($noidung, $tentaptin, $tenhinhqcab, $tenhinhqcabc, $tenhinhndab, $tenhinhndabc, $tenhinhndabcd, $tieude, $thuocloai, $mota, $today, $trangchu, $id, $noidung_en, $tieude_en, $mota_en, $title, $tukhoa, $facebook, $linkurl, $xem, $nguon);
        }

        function upload($noidung, $tentaptin, $tenhinhqcab, $tenhinhqcabc, $tenhinhndab, $tenhinhndabc, $tenhinhndabcd, $tieude, $thuocloai, $mota, $today, $trangchu, $id, $noidung_en, $tieude_en, $mota_en, $title, $tukhoa, $facebook, $linkurl, $xem, $nguon)
        {
          include("db.php");

          global $fileup;

          $truyvan = "UPDATE `tin_dichvu` SET $fileup `hinhqcab` = '$tenhinhqcab',
