...
<body>
	...
	$result = mysqli_query(
		$link,
		"SELECT * FROM du_an ORDER BY id DESC limit $start,$limit",
	);
	...
	if (mysqli_num_rows($result) != 0) {
		...
		while ($row = mysqli_fetch_object($result)) {
			...
			echo "<td align='div'><a href='quan_tri.php?p=xoa_duan&id=" .
				$id .
				"'­ onclick=\"return confirm('Bạn có muốn xóa thông tin này ?')\"><img src='images/xoa_record.png' border='0'></a></td>";

			echo "<td align='div'><a href='quan_tri.php?p=sua_duan&id=" .
				$id .
				"&thuocloai=" .
				$thuocloai .
