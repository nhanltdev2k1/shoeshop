   ...
   <tr>
    <td height="80" colspan="2" align="center" valign="top"><form action="" method="post" enctype="multipart/form-data" name="tt_mh" id="tt_mh"  onsubmit="return checkInput();">
      <table width="100%" border="1" bordercolor="black" style="border-collapse:collapse; border-color:#FF0000">
       ...
       <tr>
       <tr>
          <td width="142" align="left" valign="top"><div align="left"><strong>Hình ảnh</strong><br /> KT 800 X 500 PX </div></td>
        ...
        <tr>
          <td><div align="left"><strong>Tiêu đề</strong> </div></td>
          <td><div align="left">
              <label>
        ...
        <tr>
          <td valign="top"><div align="left"><strong>Mô tả Ngắn</strong> </div></td>
          <td><div align="left">
              <label></label>
              ...
              <textarea name="mota" id="textarea" cols="70" rows="5" maxlength="360"></textarea>
               ...
               <tr>
          <td><div align="left"><strong>Link web </strong> </div></td>
          <td><div align="left">
              <label>
