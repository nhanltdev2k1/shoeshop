    ...
    <tr>
      <td height="112" valign="top"><?php
                                    ...
                                    function upload($noidung, $tentaptin, $tenhinhqcab, $tenhinhqcabc, $tenhinhndab, $tenhinhndabc, $tenhinhndabcd, $tieude, $thuocloai,  $mota, $chuoi, $trangchu,  $id,  $noidung_en, $tieude_en, $mota_en, $title, $tukhoa, $facebook, $linkurl, $xem, $nguon, $sao)
                                    {
									  ...
									  include("db.php");
									  global $fileup;
                                      $truyvan = "UPDATE `tin_title` SET $fileup `hinhqcab` = '$tenhinhqcab',
...
`star` = '$sao' WHERE `id` =$id;";
    ...
    <tr>
      <td height="203" colspan="2" align="center" valign="top"><?php
                                                                include('db.php');
                                                                $id = $_REQUEST["id"];
                                                                $result = mysqli_query($link,"SELECT * FROM tin_title where id like '$id' ");
          ...
          <table width='97%' border='1' bordercolor='black' style='border-collapse:collapse'>
            ...
            <tr>
              ...
              <td>
                <?php
                $id = $_REQUEST["id"];
                $sq = mysqli_query($link,"SELECT * FROM tin_title where id=" . $id . "");
                $loai = mysqli_fetch_array($sq);
                ?>
                <select name="thuocloai">
                  <?php
                  $selected = "";
                  $sql = mysqli_query($link,"SELECT * FROM loai_tin_title ORDER BY id DESC");
    ...
    <tr>
      ...
      <td>
        <div align="left">
          <label>
            <input name="tieude_en" type="text" id="masp2" value="<?php echo "$tieude_en"; ?>" size="50" maxlength="270" />
          </label>
        </div>
      </td>
    </tr>
