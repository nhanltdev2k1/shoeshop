    ...
    <tr>
      <td height="46" valign="top">
        ...
        function upload($thuocloai, $thuocloai_en)
        {
		  ...
		  include("db.php");
          $truyvan = " INSERT INTO `loai_tin_title` (`id`, `thuocloai`, `thuocloai_en`) VALUES (NULL, '$thuocloai', '$thuocloai_en')";
        ...
        function xoataptin($tentaptin)
        {
          ...
          $truyvan = "DELETE FROM tin_title WHERE id = $masotaptin ";
          $ketqua_truyvan = mysqli_query($link,$truyvan);
        }
        ?></td>
      <td valign="top">
